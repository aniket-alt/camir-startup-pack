...
|---|---|---|---|---|
| **P1 Priya** — drop-in, 60-person SaaS | None directly; ~$4–6k/mo of GPU (two rented cards at $2.50–3.75/hr [S26]) | **Rarely.** She self-hosts for a contractual data-residency reason [S28], not for cost | A default configuration that cannot silently hurt her, and shadow mode | Below the floor. **She is an Open-tier user, and the pack should stop pretending otherwise** |
