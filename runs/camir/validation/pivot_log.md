...
| **P2** | The **artifact share is under 2pp** on well-instrumented pools (E2's declared FAIL line; 2–5pp is amber and triggers a second corpus, not a pivot) | Gate 1 | Drop the harness thesis; CAMIR becomes an ordinary router in a plateaued field [S4] and there is no reason to prefer it. Treat as close to P1 | A13, E2, [S5] |
| **P3** | **Fewer than 6 of 20 screened teams qualify** on self-hosted production volume (E4's declared KILL line) | After 20 screening calls | **Hybrid pools move to the primary roadmap** (A9 flips): admit hosted API models as a top tier and re-scope the frontier to mixed pools | A3, [G1] |
